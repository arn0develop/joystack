...
import 'src/component/Pages/PrivacyPolicy/style.scss'
...
class PrivacyPolicy extends React.Component<Properties, State> {
  ...
  private async fetchContent () {
    ...
    const languageUrls = {
      en: 'https://www.iubenda.com/api/privacy-policy/99442124/no-markup',
      de: 'https://www.iubenda.com/api/privacy-policy/69638684/no-markup'
    }
  ...
  render() {
    ...
    if (params.language !== language) {
      return <Redirect to={`/privacy/${language}`} />
    }
    return (
      <div>
        <NavigationBar />
...
export default connect(mapStateToProperties)(PrivacyPolicy)
